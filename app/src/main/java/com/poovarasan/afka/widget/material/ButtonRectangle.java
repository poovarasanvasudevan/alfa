package com.poovarasan.afka.widget.material;
...
//		paddingTop = Utils.dpToPx(16, getResources());
        super.minWidth = 80;
        super.minHeight = 50;
        super.background = R.drawable.btn_rect;
    ...
    private void setDefaultAttr() {
        ...
        textButton.setText(getText());
        textButton.setTextColor(Color.WHITE);
        textButton.setTypeface(null, Typeface.BOLD);
        RelativeLayout.LayoutParams params = new RelativeLayout.LayoutParams(LayoutParams.WRAP_CONTENT, LayoutParams.WRAP_CONTENT);
        params.addRule(RelativeLayout.CENTER_IN_PARENT, RelativeLayout.TRUE);
        params.setMargins(Utils.dpToPx(3, getResources()), Utils.dpToPx(3, getResources()), Utils.dpToPx(3, getResources()), Utils.dpToPx(3, getResources()));
