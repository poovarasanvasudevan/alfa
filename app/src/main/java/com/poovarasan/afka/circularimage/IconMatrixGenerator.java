...
public class IconMatrixGenerator {
    ...
    public Matrix generateMatrix(ImageView.ScaleType scaleType, Bitmap bitmap, com.poovarasan.afka.circularimage.DrawerHelper.DrawingType drawingType, boolean translateVertically) {
    ...
    private void setMatrixForHalfCircle(Matrix matrix, Bitmap bitmap, com.poovarasan.afka.circularimage.DrawerHelper.DrawingType drawingType, boolean translateVertically) {
        float scale;
    ...
    private void setMatrixForQuarterCircle(Matrix matrix, Bitmap bitmap, com.poovarasan.afka.circularimage.DrawerHelper.DrawingType drawingType) {
