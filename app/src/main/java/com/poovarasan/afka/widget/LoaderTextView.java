...
public class LoaderTextView extends IconicsTextView implements LoaderView {
    ...
    public void setLoaderHeight(int height) {
        loaderController.setHeightWeight(height);
    }

    public void setLoaderWidth(int weight) {
        loaderController.setWidthWeight(weight);
    }
