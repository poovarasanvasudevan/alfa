...
package com.poovarasan.chatkit.messages;
...
import com.poovarasan.chatkit.commons.Style;
...
class MessageInputStyle extends Style {
    ...
    static MessageInputStyle parse(Context context, AttributeSet attrs) {
        ...
        style.showAttachmentButton = typedArray.getBoolean(R.styleable.MessageInput_showAttachmentButton, true);
