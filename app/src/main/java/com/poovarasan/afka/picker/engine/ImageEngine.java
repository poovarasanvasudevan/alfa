 ...
 */
package com.poovarasan.afka.picker.engine;
...
/**
 * Image loader interface. There are predefined {@link com.poovarasan.afka.picker.engine.impl.GlideEngine}
 * and {@link com.poovarasan.afka.picker.engine.impl.PicassoEngine}.
 */
...
public interface ImageEngine {
     ...
     * @param uri       Uri of the loaded image
     */
    void loadImage(Context context, int resizeX, int resizeY, SimpleDraweeView imageView, Uri uri);
     ...
     * @param uri       Uri of the loaded image
     */
    void loadGifImage(Context context, int resizeX, int resizeY, SimpleDraweeView imageView, Uri uri);
