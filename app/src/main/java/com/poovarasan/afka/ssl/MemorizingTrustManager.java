...
public class MemorizingTrustManager implements X509TrustManager {
     ...
     * </p> <ol> <li>Success, if the wrapped defaultVerifier accepts the certificate.</li>
     * <li>Success, if the server certificate is stored in the keystore under the given
     * hostname.</li> <li>Ask the user and return accordingly.</li> <li>Failure on exception.</li>
     * </ol>
     *
     ...
     * PendingIntent)</code> since it was remove in Android API level 23.
     */
